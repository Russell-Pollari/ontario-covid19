...
echo Leeds $(wget -q -O - https://healthunit.org/coronavirus/ | grep 'confirmation' |  sed -E -e  's/.*confirmation of ([0-9]+) cases.*$/\1/') && wget -q https://web.archive.org/save/https://healthunit.org/coronavirus/ 
