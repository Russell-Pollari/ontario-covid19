...
const getData = (callback) =>  {
	jsonp(dataUrl, function(data) {
		...
		records.map(record => {
			...
			record.icu_no_ventilator = record['Number of patients in ICU with COVID-19'] - record['Number of patients in ICU on a ventilator with COVID-19'];
			...
			yesterdayHospital = record[icuField];
